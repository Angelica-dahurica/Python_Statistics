...
# the other 150 received the patch and did not meet with a support group. 
# At the end of the study, 40 of the participants in the patch plus support group had quit smoking 
# while only 30 smokers had quit in the other group.
# (1) Create a two-way table presenting the results of this study.
# (2) Answer each of the following questions under the null hypothesis that being part of a support group does not 
# affect the ability of people to quit smoking, and indicate whether the expected values are higher or lower than the observed values.
