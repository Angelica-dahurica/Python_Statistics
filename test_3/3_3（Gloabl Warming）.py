...
# Is there strong evidence of global warming? Let's consider a small scale example, 
...
# (1) Is there a relationship between the observations collected in 1968 and 2008? 
# Or are the observations in the two groups independent? Explain
...
# (6) Based on the results of this hypothesis test, 
# would you expect a confidence interval for the average difference between the temperature measurements from 1968 and 2008 to include 0? 
# Explain | none
